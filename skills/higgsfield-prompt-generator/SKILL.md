...
═══════════════════════════════════════════════════
КРЕО-ПРАВИЛА ТЕКСТА И КАЧЕСТВА (синхрон с PROMPT-4, фикс 2026-05-24)
═══════════════════════════════════════════════════
...
АРХЕТИП INFOBIZ-доход «ЛИД-МАГНИТ + МИНИМАЛИЗМ» (из референсов Игоря). Дефолт для инфобиз-доход с лид-магнитом — НЕ «фото эксперта», а: минимализм-вёрстка 9:16 (плоский фон чёрный/белый/акцент, крупный жирный заголовок «Как [ЦА] [результат]?», подзаголовок-выгода в рамке-боксе, один акцент-цвет), CTA лид-магнит «Пиши "[СЛОВО]" в Директ, чтобы забрать», пруф = реальные скрины кабинета (CTR/CPC-таблицы 🔥, V18 substantiation), флэт-иконки папка «Креативы» / воронка / «Результаты». Модель GPT Image 2 (текст/вёрстка). БЕЗ named-гуру / гор денег / гарантий дохода (income-claim → гейт). ПРИОРИТЕТ: для INFOBIZ-доход минимализм-статика побеждает GREY-правило «UGC первым». EdTech-вариант (белый навык — язык / IT-профессия): та же минимализм-вёрстка + лид-магнит, тон WHITE, БЕЗ income-фрейма; пруф НЕ обязателен — схема/диаграмма (структура курса / этапы / воронка) вместо скринов дохода. **ГРАНИЦА (guard 2026-05-23):** этот лид-магнит-хук («слово в Директ» + минимализм) — придумывается ТОЛЬКО для INFOBIZ-доход / EdTech. На GREY-DR ниши (нутра-арбитраж / беттинг / товарка) НЕ переносить — там оффер прямой продукт/результат из offer-generator. Лид-магнит-как-механику-воронки (HIGH_TICKET «замер», white-нутра воронку) НЕ трогает.
