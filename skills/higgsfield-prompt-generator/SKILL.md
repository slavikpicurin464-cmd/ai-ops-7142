...
— iPhone 15 Pro, iPhone 16 Pro — безопасны на 2026-Q1.
— iPhone 17 Pro — спорно (ещё не в массовой выборке), вместо него «smartphone vlog look» или «iPhone 15 Pro».
...
— Профиль GREY_NICHE когда крео с AI-generated visual идёт в платный плейсмент Meta / Google / TikTok.
...
— ВАЖНО: если подпрофиль = MEDICAL_HEAVY (стоматология, инвазивная косметология, дерматология, пластика) — переключайся на блок «premium-static-only → подсекция MEDICAL_HEAVY стоматология» (см. соответствующий раздел). Часть приёмов LOCAL_SERVICE недоступна.
